...
const About = () => {
  return (
    <div className="relative w-[100vw] h-[110vh] flex gap-[8rem] px-[8rem] pt-[12rem] justify-center xs:max-md:px-[2rem] xs:max-md:pt-0 xs:max-md:flex-col xs:max-md:gap-[1.5rem] xs:max-md:items-center xs:max-md:justify-center xs:max-md:h-[130vh] items-center overflow-x-hidden">
