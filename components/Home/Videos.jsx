...
const Videos = () => {
  return (
    <div className="w-[100vw] h-[120vh] flex flex-col pt-[7vh] items-center gap-10 xs:max-md:pt-[5vh]">
      <h1 className="text-[60px] font-extrabold xs:max-md:text-[45px]">
        VIDEOS
      </h1>
      <p className="text-[22px] text-[#1B3C87] font-medium mt-[-3.7rem] xs:max-md:text-[13px] xs:max-md:mt-[-3rem] xs:max-md:text-center">
